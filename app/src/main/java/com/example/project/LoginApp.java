    ...
    public class LoginApp extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                if (validateInput(email, password)) {
                    ...
                    if (loginUser(email, password)) {
                        if (rememberMe) {
                            ...
                            clearEmailFromPreferences(); // Clear email from preferences if "Remember Me" is unchecked
                        }
                        boolean isAdmin = databaseHelper.isAdminEmail(email,context);

                        if (isAdmin) {
                            intent = new Intent(LoginApp.this, adminFinalActivity.class);
                            intent.putExtra("EmailUser",email);
                            startActivity(intent);

                        } else {
                            // The email does not belong to an admin


                        intent = new Intent(LoginApp.this, MainActivity.class);
                        intent.putExtra("EmailUser",email);
                        startActivity(intent);
            ...
            btnSignUp.setOnClickListener(view -> {
                Intent intent = new Intent(LoginApp.this, SignupActivity.class);
                startActivity(intent);
            });
